...
export default function SpecialtiesPage() {
  return (
    <>
      ...
      <PracticeCTA title="Your specialty. Your workflow. Our attention." description="Don't see your specialty listed? We work with practices across a wide range of specialties — reach out and we'll discuss your specific billing needs." buttonLabel="Talk to our team" />
    </>
  );
}
>>>>>>> ali
